  ...
  (
    {
      ...
      onResourceNamesChange,
      onKeyDown,
      placeholder = "Ask to learn, quiz, compare, or create flashcards...",
      disabled = false,
      className,
      onSubmit,
      onAddImage,
      ...
      editorProps: {
        attributes: {
          class: cn(
            ...
            "px-1 py-1.5 rounded-t-lg bg-transparent text-sm leading-normal",
            "min-h-[32px] max-h-[40vh] overflow-y-auto",
