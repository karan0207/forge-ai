...
/**
 * Strips em dashes and other typographic artifacts the LLM tends to produce.
 */
...
function convertContentToMarkdown(
  ...
  if (!content) return "";
  if (typeof content === "string") return cleanLlmText(content);
  ...
  if (Array.isArray(content)) {
    ...
    for (const item of content) {
      if (item?.type === "text") {
        parts.push(cleanLlmText(item.text ?? ""));
