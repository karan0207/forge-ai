      ...
      <div className="flex h-screen bg-gray-50 relative">
        ...
        <div
          className={cn(
            ...
            // Mobile: overlay on top; Desktop: side-by-side
            isChatOpen
              ? "fixed inset-y-0 left-0 z-50 w-[85vw] sm:w-80 sm:relative sm:z-auto"
              : "w-0 overflow-hidden"
          )}
        >
          {isChatOpen && (
          ...
          <button
            ...
            className="absolute -right-10 top-1/2 -translate-y-1/2 bg-white border border-gray-200 rounded-r-lg p-2 hover:bg-gray-50 z-50">
            {isChatOpen ? (
